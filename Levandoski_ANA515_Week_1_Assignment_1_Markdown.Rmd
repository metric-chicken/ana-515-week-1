...
# Install dependencies if they are missing. In this case, it's tinytex, ggplot2, and dplyr. 
deps.list <- c("tinytex", "ggplot2", "dplyr")
new.packages <- deps.list[!(deps.list %in% installed.packages()[,"Package"])]
